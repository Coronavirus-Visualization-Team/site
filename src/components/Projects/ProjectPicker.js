            ...
            <Container
                ...
                <Grid width={['25%', '25%']}
                    ...
                    <Box 
                        ...
                        sx={{ variant: two ? 'styles.projectPickerActive' : 'styles.projectPicker' }}>Project 2</Box>
                    <Box 
                        onClick={() => {
                            toggleOne(false)
                            toggleTwo(false)
                        ...
                        sx={{ variant: three ? 'styles.projectPickerActive' : 'styles.projectPicker' }}>Project 3</Box>
                    <Box 
                        onClick={() => {
                            toggleOne(false)
                            toggleTwo(false)
                        ...
                        sx={{ variant: four ? 'styles.projectPickerActive' : 'styles.projectPicker' }}>Project 4</Box>
                </Grid>
            </Container>
            {one && <FeaturedProject 
